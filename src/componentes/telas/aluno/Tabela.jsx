...
function Tabela() {
    ...
    return (
        <div style={{ padding: '20px' }}>
            <h1 class="mb-4 text-3xl font-extrabold text-gray-900 md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Listagem de</span> Alunos.</h1>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Cursando</th>
                            </tr>
                        </thead>
                        <tbody className="bg-white divide-y divide-gray-200">
                            {
                                listaObjetos.map(objeto => (
                                    <tr key={objeto.codigo}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">{objeto.data_nascimento}</td>
                                        <td className="px-6 py-4 whitespace-nowrap">{objeto.telefone}</td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            {objeto.cursos && objeto.cursos.some(curso => curso.ativo) ? (
